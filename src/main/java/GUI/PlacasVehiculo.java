...
public class PlacasVehiculo extends javax.swing.JFrame {
    ...
    public void llenarTabla() {
        ...
        for (Placa placa : placas) {
            ...
            int ve = placa.getVehiculo().getNum_serie();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlacasVehiculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                // new PlacasVehiculo().setVisible(true);
            }
        });
    }
